        ...
        <div className="bg-[#0e0019] py-12 border-t border-border/20 mt-12">
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-xs text-gray-400">
            ...
            <div className="space-y-2">
              <span className="text-[10px] uppercase font-bold tracking-wider text-accent block">Operations Hubs</span>
              <div className="space-y-1.5 font-medium">
                <span className="flex items-center gap-1.5 text-gray-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent" /> Mumbai Studio (BKC)
                </span>
                <span className="flex items-center gap-1.5 text-gray-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent" /> Bangalore Tech Hub (MG Road)
                </span>
                <span className="flex items-center gap-1.5 text-gray-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent" /> Delhi NCR Office
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5 font-medium">
                <span className="flex items-center gap-1.5 text-gray-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent" /> support@influencebridge.com
                </span>
                <span className="flex items-center gap-1.5 text-gray-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent" /> +91 88818 00808
                </span>
              </div>
            </div>
